      ...
      <div className="hidden md:flex md:w-2/5 lg:w-1/2 bg-gradient-to-b from-purple-600 via-indigo-600 to-blue-600 text-white flex-col justify-between px-8 py-10">
        <div>
          ...
          <p className="text-sm text-white/80 max-w-sm">
            Sign in to manage projects, report bugs, and track developer updates in one place.
          </p>
        </div>
        <p className="text-[11px] text-white/60">
          Tip: Use your organization email to access assigned projects faster.
        </p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-sm border border-slate-100 p-6 sm:p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-3 mb-4">
            ...
            <button className="w-full rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-blue-700 transition">
              Log in
            </button>
          </form>
